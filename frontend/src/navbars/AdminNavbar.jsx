...
import { UserRound, ClipboardList, Calendar, Activity, Computer, FileText, Settings, HelpCircle, Search, Timer, LogOut, ChevronDown, Menu, X } from 'lucide-react';
...
export default function AdminNavbar({ toggleSidebar }) {
  ...
  const mainNavItems = [
    ...
    { label: 'Clinical Records', icon: <ClipboardList className="w-5 h-5" />, href: '/records' },
    { label: 'System Logs', icon: <Computer className="w-5 h-5" />, href: '/logging/system-logs' },
    { label: 'Analytics', icon: <Activity className="w-5 h-5" />, href: '/users/user-analytics' },
          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center">
              ...
              <Link to="/home" className="flex items-center">
                ...
                <span className="hidden sm:block text-lg text-gray-700 dark:text-gray-200">Hospital Admin</span>
              </Link>
            ...
            <div className="hidden md:flex md:items-center md:space-x-1">
              {mainNavItems.map(item => (
                <Link
                  key={item.href}
                  to={item.href}
                  className="flex items-center px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-gray-800 rounded-md transition"
                >
                  {item.icon}
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <div className="relative ml-1" ref={userMenuRef}>
                ...
                >
                  <div className="w-7 h-7 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-blue-800 dark:text-blue-300">
