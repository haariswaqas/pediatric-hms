...
export default function NurseNavbar({ toggleSidebar }) {
  ...
  const mainNavItems = [
    ...
    { label: 'Shifts',      icon: <Timer className="w-5 h-5" />, href: '/shifts/assignments/nurses' },
    {label: 'Admit Patient', icon: <UserRound className="w-5 h-5" />, href: '/children/add' },
    

    { label: 'Reports',     icon: <Computer className="w-5 h-5" />, href: '/reports' },
  ];
