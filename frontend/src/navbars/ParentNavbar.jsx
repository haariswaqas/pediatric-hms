...
export default function ParentNavbar({ toggleSidebar }) {
  ...
  const mainNavItems = [
    { label: 'My Children', icon: <Users className="w-5 h-5" />, href: '/children' },
    { label: 'Appointments', icon: <Calendar className="w-5 h-5" />, href: '/appointments' },
    { label: 'Vaccinations', icon: <Syringe className="w-5 h-5" />, href: '/vaccines/vaccination-records' },
    { label: 'AI Chat', icon: <MessageCircle className="w-5 h-5" />, href: '/chatbot' },
  ];
          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center">
              ...
              <Link to="/home" className="flex items-center">
                <Baby className="w-8 h-8 text-blue-600 dark:text-blue-400 mr-2" />
                <span className="text-blue-600 dark:text-blue-400 font-bold text-xl mr-2">Parent Portal</span>
                ...
                {userMenuOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50">
                    ...
                    <button
                      ...
                      className="flex items-center w-full px-3 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-b-lg"
                    >
